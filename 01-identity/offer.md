...
**SSOT** de la oferta. Si en algún otro archivo aparece descripción de la oferta, debe linkear a este archivo, no duplicarla.
...
- Directo, claro, sin floritura.
- Vocabulario técnico cuando agrega precisión.
- Lenguaje argentino, conversacional ("dale", "te propongo", "sin que nadie se queje").
- NO usar buzzwords vacíos ("transformación", "potenciar", "soluciones innovadoras").
- NO sonar a agencia de marketing.
- Si una palabra no tiene definición precisa, no se usa.
...
- ❌ Diseño gráfico, edición de video, branding visual.
