...
3-4 semanas. Dividido en 4 fases.
...
Documentar todas las entrevistas en notas estructuradas.
...
Para cada touchpoint del blueprint, identificar:
...
Listar 4-7 pain points principales. Cada uno con marcador ✅ 🔵 ❓ según nivel de certeza.
...
Mandar documento final + grabación de la reunión (si se grabó).

### Cobranza del 50% restante

Al entregar el documento, mandar factura por el 50% restante.
...
- Sin entrevistas a clientes finales (alcance no lo permite). Se nombran como "recomendado para fase siguiente".

---

## Adaptaciones para Modelo C

Modelo C es 3-4 meses, no 3-4 semanas. Diferencia principal: post-entrega del documento, hay 8-12 semanas de acompañamiento.
