...
### 1. Cobrar antes de empezar

Sin excepciones. Principio P8.

La fecha de inicio del proyecto es la fecha del primer pago, no la fecha del "sí" verbal.

### 2. Contrato siempre

Aunque sea una carta acuerdo de 1 página. Sin firma, no hay proyecto.

### 3. La primera persona que habla después del precio, pierde
...
5. Crear carpeta del cliente en sistema de archivos.
6. Actualizar tracking de clientes activos.
